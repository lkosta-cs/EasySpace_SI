...
export default function PendingBookingsPage() {
  ...
  // Group by recurringGroupId
    const grouped = (bookings as PendingBooking[]).reduce((acc: Record<string, PendingBooking[]>, booking: PendingBooking) => {
            ...
            return (
              ...
              >
                    ...
                    <div className="flex items-center gap-2 mb-1">
                      ...
                      {isRecurring && (
                        <span className="text-xs bg-purple-100 text-purple-700 px-2 py-0.5 rounded-full">
                          Recurring — {groupBookings.length} sessions
                        </span>
                      )}
                    </div>
                ...
                <div className="flex gap-2">
                  ...
                  >
                    {isRecurring ? `Approve all ${groupBookings.length}` : 'Approve'}
                  </button>
                  <button
                  ...
                  >
                    {isRecurring ? `Reject all ${groupBookings.length}` : 'Reject'}
                  </button>
                </div>
              </div>
            );
